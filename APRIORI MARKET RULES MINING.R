...
#it results in a sparse matrix suitable for 
#transactional data.
summary(groceries) 
...
#itemFrequency means support level
...
# Support is a measure of how frequently an 
#itemset appears in the dataset.

# Confidence is a measure of the strength of 
#the association between the antecedent and the
#consequent in a rule.

# Lift indicates whether the presence of the 
#antecedent has any effect on the likelihood of
#the consequent.
